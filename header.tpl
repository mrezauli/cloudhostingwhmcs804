...
<body id="home" data-phone-cc-input="{$phoneNumberInputStyle}">
        ...
        <nav id="main-nav" class="navxbar navxbar-default navxbar-fixed-top" role="banner">
            <div class="containerx">
                <div class="navxbar-header">
                    ...
                    <a class="navxbar-brand" href="index.php"><img src="{$WEB_ROOT}/templates/{$template}/files/images/logo.png" alt="logo"></a>
                </div>
